...
/* harmony import */ var _mui_material_FormControlLabel__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(8185);
...
/* harmony import */ var _mui_material_Unstable_Grid2__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(4904);
/* harmony import */ var _mui_material_Unstable_Grid2__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_mui_material_Unstable_Grid2__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(1853);
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(next_router__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var alchemy_sdk__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(3796);
/* harmony import */ var alchemy_sdk__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(alchemy_sdk__WEBPACK_IMPORTED_MODULE_16__);
/* harmony import */ var _rainbow_me_rainbowkit__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(6921);
/* harmony import */ var wagmi__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(8906);
/* harmony import */ var wagmi__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(wagmi__WEBPACK_IMPORTED_MODULE_18__);
/* harmony import */ var _config_env_vars__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(8344);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(1982);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(ethers__WEBPACK_IMPORTED_MODULE_20__);
/* harmony import */ var _config_network__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(9041);
/* harmony import */ var wagmi_providers_jsonRpc__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(1176);
/* harmony import */ var wagmi_providers_jsonRpc__WEBPACK_IMPORTED_MODULE_22___default = /*#__PURE__*/__webpack_require__.n(wagmi_providers_jsonRpc__WEBPACK_IMPORTED_MODULE_22__);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_navbar__WEBPACK_IMPORTED_MODULE_2__, _rainbow_me_rainbowkit__WEBPACK_IMPORTED_MODULE_17__]);
([_components_navbar__WEBPACK_IMPORTED_MODULE_2__, _rainbow_me_rainbowkit__WEBPACK_IMPORTED_MODULE_17__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const { NEXT_PUBLIC_ALCHEMY_ID , NEXT_PUBLIC_INFURA_ID , NEXT_PUBLIC_ETHERSCAN_API_KEY  } = _config_env_vars__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .Z;


const { chainn , rpc , createn , contractn , menun  } = _config_network__WEBPACK_IMPORTED_MODULE_21__/* ["default"] */ .Z;
...
const { chains , provider  } = (0,wagmi__WEBPACK_IMPORTED_MODULE_18__.configureChains)([
    chainn
], [
    (0,wagmi_providers_jsonRpc__WEBPACK_IMPORTED_MODULE_22__.jsonRpcProvider)({
        rpc: (chainn)=>({
                http: rpc
            })
    })
]);
const { connectors  } = (0,_rainbow_me_rainbowkit__WEBPACK_IMPORTED_MODULE_17__.getDefaultWallets)({
    appName: "the Wall",
    chains
});
const wagmiClient = (0,wagmi__WEBPACK_IMPORTED_MODULE_18__.createClient)({
    autoConnect: true,
    connectors,
    provider
});
...
function useTtag0() {
    ...
    if (walladdrs != null && addrst == 0) {
        ...
        Contract = new ethers__WEBPACK_IMPORTED_MODULE_20__.ethers.Contract(contractaddrs, Abi, signerw);
        addrst = 1;
    }
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        // update the ui elements
        async function updateUIStates() {
            ...
            setArtist(artistS);
            setTime(timeS);
            const provider3 = new ethers__WEBPACK_IMPORTED_MODULE_20__.ethers.providers.JsonRpcProvider("https://eth-mainnet.g.alchemy.com/v2/Z-ifXLmZ9T3-nfXiA0B8wp5ZUPXTkWlg");
            for(let n = 0; n < sup; n++){
            ...
            s = ethers__WEBPACK_IMPORTED_MODULE_20__.ethers.utils.formatUnits(s, 0);
            setSup(s);
        }
...
let Contract = new ethers__WEBPACK_IMPORTED_MODULE_20__.ethers.Contract(contractaddrs, Abi, signerw);
let Token = new ethers__WEBPACK_IMPORTED_MODULE_20__.ethers.Contract(tokenaddrs, Abi, signerw);
//const Contract = new ethers.Contract(contractaddrs, Abi, signerw);
const CreateWall = new ethers__WEBPACK_IMPORTED_MODULE_20__.ethers.Contract(createaddrs, Abi, signerw);
const App = ({ Component , pageProps  })=>{
    ...
    const createWallT = async ()=>{
        ...
        const provider2 = new ethers__WEBPACK_IMPORTED_MODULE_20__.ethers.providers.Web3Provider(window.ethereum);
        // Setup
        await provider2.send("eth_requestAccounts", []);
        try {
            (next_router__WEBPACK_IMPORTED_MODULE_15___default().pathname);
    ...
    const callTag = async ()=>{
        ...
        const settings = {
            ...
            network: alchemy_sdk__WEBPACK_IMPORTED_MODULE_16__.Network.MATIC_MAINNET
        };
        await provider2.send("eth_requestAccounts", []);
        try {
            // await provider2.send("eth_requestAccounts", []);// await // MetaMask requires requesting permission to connect users accountsSS
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(next_themes__WEBPACK_IMPORTED_MODULE_3__.ThemeProvider, {
        ...
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
            ...
            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(wagmi__WEBPACK_IMPORTED_MODULE_18__.WagmiConfig, {
                client: wagmiClient,
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_rainbow_me_rainbowkit__WEBPACK_IMPORTED_MODULE_17__.RainbowKitProvider, {
                    chains: chains,
                    children: [
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Box__WEBPACK_IMPORTED_MODULE_5___default()), {
                            ...
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((_mui_material_Unstable_Grid2__WEBPACK_IMPORTED_MODULE_14___default()), {
                                container: true,
                                spacing: 1,
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Unstable_Grid2__WEBPACK_IMPORTED_MODULE_14___default()), {
                                        xs: 2,
                                        className: "left-6 top-10 m-auto",
                        ...
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Dialog__WEBPACK_IMPORTED_MODULE_9___default()), {
                            open: open,
                            onClose: handleClose,
                            ...
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_FormControlLabel__WEBPACK_IMPORTED_MODULE_12___default()), {
                                        control: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Switch__WEBPACK_IMPORTED_MODULE_13___default()), {
