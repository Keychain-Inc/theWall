...
/* harmony import */ var wagmi_providers_alchemy__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(9770);
/* harmony import */ var wagmi_providers_alchemy__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(wagmi_providers_alchemy__WEBPACK_IMPORTED_MODULE_20__);
/* harmony import */ var _config_env_vars__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(8344);
...
const { NEXT_PUBLIC_ALCHEMY_ID , NEXT_PUBLIC_INFURA_ID , NEXT_PUBLIC_ETHERSCAN_API_KEY  } = _config_env_vars__WEBPACK_IMPORTED_MODULE_21__/* ["default"] */ .Z;
...
const { chains , provider  } = (0,wagmi__WEBPACK_IMPORTED_MODULE_19__.configureChains)([
    wagmi__WEBPACK_IMPORTED_MODULE_19__.chain.polygon
], [
    (0,wagmi_providers_alchemy__WEBPACK_IMPORTED_MODULE_20__.alchemyProvider)({
        apiKey: alchemyId
    })
]);
...
function useTtag0() {
    ...
    if (walladdrs != null && addrst == 0) {
        ...
        Contract = new ethers__WEBPACK_IMPORTED_MODULE_22__.ethers.Contract(contractaddrs, Abi, signerw);
        addrst = 1;
    }
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        // update the ui elements
        async function updateUIStates() {
            ...
            setArtist(artistS);
            setTime(timeS);
            const provider3 = new ethers__WEBPACK_IMPORTED_MODULE_22__.ethers.providers.JsonRpcProvider("https://eth-mainnet.g.alchemy.com/v2/Z-ifXLmZ9T3-nfXiA0B8wp5ZUPXTkWlg");
            for(let n = 0; n < sup; n++){
            ...
            s = ethers__WEBPACK_IMPORTED_MODULE_22__.ethers.utils.formatUnits(s, 0);
            setSup(s);
        }
...
let Contract = new ethers__WEBPACK_IMPORTED_MODULE_22__.ethers.Contract(contractaddrs, Abi, signerw);
let Token = new ethers__WEBPACK_IMPORTED_MODULE_22__.ethers.Contract(tokenaddrs, Abi, signerw);
//const Contract = new ethers.Contract(contractaddrs, Abi, signerw);
const CreateWall = new ethers__WEBPACK_IMPORTED_MODULE_22__.ethers.Contract(createaddrs, Abi, signerw);
const App = ({ Component , pageProps  })=>{
    ...
    const createWallT = async ()=>{
        ...
        const provider2 = new ethers__WEBPACK_IMPORTED_MODULE_22__.ethers.providers.Web3Provider(window.ethereum);
        // Setup
                                                ...
                                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((_mui_material_Select__WEBPACK_IMPORTED_MODULE_9___default()), {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_MenuItem__WEBPACK_IMPORTED_MODULE_7___default()), {
                                                            value: "0x91fc82f5c588c00985aa264fc7b45ee680110703",
                                                            children: "Main"
                                                        }),
                                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_MenuItem__WEBPACK_IMPORTED_MODULE_7___default()), {
